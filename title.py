    ...
    if protocol_type == 'SHADOWSOCKS':
        for element in array_configuration:
            ...
            for ip_address in ips_list:
                ...
                config["title"] = f"Vip-Wopi SS-TCP-NA {country_flag} {country_code}"
        ...
        for element in array_configuration:
            ...
            for ip_address in ips_list:
                ...
                # Modify configuration title based on server and protocol properties
                config["title"] = f"Vip-Wopi TR-{config_type}-{config_secrt} {country_flag} {country_code}"
        ...
        for element in array_configuration:
            ...
            for ip_address in ips_list:
                ...
                # Modify configuration title based on server and protocol properties
                config["title"] = f"Vip-Wopi VM-{config_type}-{config_secrt} {country_flag} {country_code}"
        ...
        for element in array_configuration:
            ...
            for ip_address in ips_list:
                ...
                # Modify configuration title based on server and protocol properties
                config["title"] = f"Vip-Wopi VL-{config_type}-{config_secrt} {country_flag} {country_code}"
        ...
        for element in array_configuration:
            ...
            for ip_address in ips_list:
                ...
                # Modify configuration title based on server and protocol properties
                config["title"] = f"Vip-Wopi TUIC-UDP {country_flag} {country_code}"
        ...
        for element in array_configuration:
            if element.startswith('hysteria'):
                ...
                for ip_address in ips_list:
                    ...
                    # Modify configuration title based on server and protocol properties
                    config["title"] = f"Vip-Wopi HYSTERIA-UDP {country_flag} {country_code}"
